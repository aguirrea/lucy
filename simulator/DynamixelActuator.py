...
class Actuator:
    ...
    def make_msg_sync(self, id, instruction, parameters=[]):
        msg = []
        #length_field = len(parameters) + 2
        #18*5 + 4
        length_field = 0x5E
    ...
    def sync_write(self, joints):
        ...
        for j in joints:
            ...
            p = p + [goal_position_low, goal_position_high, angular_speed_low, angular_speed_high]

        msg = self.make_msg_sync(0xfe, Instruction.SYNC_WRITE, [Register.GOAL_POSITION, 0X04] + p)
